...
| **模块**                      | **文件**                                                                                                    | **职责**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **API与鉴权**                 | `server.js` / `http/createApp.js` / `http/routes/*` / `websocket/registerAgentBoardWs.js` / `middleware.js` | 进程入口 `server.js`：`createApp()` 挂载 REST（按域拆分至 `http/routes`），`registerAgentBoardWebSocket` 注册 `/ws` 与事件桥；`middleware` 负责 CORS、鉴权、Zod 校验。会话产物：**`/api/sessions/:id/files/:fileName`** 安全下载；**`/api/sessions/:id/workspace-files`** 列出工作区根文件（供 UI 合并展示；**`CLAUDE.md`** 会话引导副本不入列表）。                                                                                                                                                                                                                                                                                                                        |
...
| **会话下载条**   | `SessionDownloadablesStrip.jsx`                     | 智能同事壳：根据 **`workspace-files`** 列出可下载扩展名（与下载 API 白名单一致），渲染于 **`user-shell-composer-footer`** 内、**`ChatInput`** 正上方，与输入区视觉连成一体（见 **`index.css`**）。                                                                                                                                                                                                                                                                            |
...
| **数据解剖**     | `RightPanel.jsx`                                    | 3 个子 Tab：`Terminal`、`Context`、**`Files`**（**`FileChangesPanel`**：工具 **Read/Write/Edit** 与原生 **ReportTool** 统计 + **`workspace-files`** 合并；可下载类型显示下载入口；需 **`sessionId`**）。                                                                                                                                                                                                                                                                      |
